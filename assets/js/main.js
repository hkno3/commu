const CATEGORIES = [
  '전체','정치','경제','사회','생활/문화','IT/과학','부동산','헬스/건강','스포츠','연예',
  '자동차','가상화폐','주식'
];
const CAT_MAP = {
...
const CAT_SLUG = {
  ...
  'IT_과학':'tech','부동산':'realestate','헬스_건강':'health',
  '스포츠':'sports','연예':'entertainment','자동차':'auto',
