...
$CATEGORIES = [
    ...
    '세계'      => ['label' => '세계',     'color' => '#8e44ad', 'bg' => '#f5f0ff'],
    'IT_과학'   => ['label' => 'IT/과학',  'color' => '#16a085', 'bg' => '#f0fffe'],
    '부동산'    => ['label' => '부동산',   'color' => '#d35400', 'bg' => '#fffbf0'],
    '헬스_건강' => ['label' => '헬스/건강','color' => '#1abc9c', 'bg' => '#f0fff8'],
    '스포츠'    => ['label' => '스포츠',   'color' => '#2471a3', 'bg' => '#f0f8ff'],
    '연예'      => ['label' => '연예',     'color' => '#c0392b', 'bg' => '#fff0fb'],
    '자동차'    => ['label' => '자동차',   'color' => '#7f8c8d', 'bg' => '#f5f5f5'],
    '날씨'      => ['label' => '날씨',     'color' => '#2980b9', 'bg' => '#e3f2fd'],
    '가상화폐'  => ['label' => '가상화폐', 'color' => '#f39c12', 'bg' => '#fff8e1'],
    '주식'      => ['label' => '주식',     'color' => '#27ae60', 'bg' => '#f1f8e9'],
    '육아'      => ['label' => '육아',     'color' => '#e91e8c', 'bg' => '#fce4ec'],
    '여행'      => ['label' => '여행',     'color' => '#00897b', 'bg' => '#e0f2f1'],
    '게임'      => ['label' => '게임',     'color' => '#6c3483', 'bg' => '#f3e5f5'],
    '패션_뷰티' => ['label' => '패션/뷰티','color' => '#e91e63', 'bg' => '#fce4ec'],
    '음식_맛집' => ['label' => '음식/맛집','color' => '#e74c3c', 'bg' => '#fff3e0'],
    '교육'      => ['label' => '교육',     'color' => '#1565c0', 'bg' => '#e8eaf6'],
    '환경'      => ['label' => '환경',     'color' => '#2e7d32', 'bg' => '#e8f5e9'],
    '법률'      => ['label' => '법률',     'color' => '#4a235a', 'bg' => '#f3e5f5'],
    '취업_직장' => ['label' => '취업/직장','color' => '#1a237e', 'bg' => '#e8eaf6'],
    '반려동물'  => ['label' => '반려동물', 'color' => '#ff6f00', 'bg' => '#fff3e0'],
    '영화'      => ['label' => '영화',     'color' => '#880e4f', 'bg' => '#fce4ec'],
];
