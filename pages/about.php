...
<div class="page-wrap">
  ...
  <div class="section">
    ...
    <p>
      정치, 경제, 사회, 문화, 스포츠 등 25개 카테고리의 최신 뉴스를 AI가 핵심만 요약해 제공하며, 누구나 익명으로 의견을 나눌 수 있습니다.
      복잡한 가입 절차 없이 뉴스를 읽고, 생각을 나누고, 다양한 시각을 접할 수 있는 열린 공간을 지향합니다.
    </p>
  </div>
  ...
  <div class="section">
    ...
    <div class="feature-grid">
      <div class="feature-item">
        <div class="icon">📡</div>
        <h3>실시간 뉴스 수집</h3>
        <p>네이버 뉴스 API를 통해 정치, 경제, 사회, 생활문화, IT과학, 스포츠, 연예 등 25개 카테고리의 최신 기사를 실시간으로 수집합니다.</p>
      </div>
      <div class="feature-item">
        <div class="icon">🤖</div>
        <h3>AI 핵심 요약</h3>
        <p>인공지능(AI)이 각 기사의 핵심 내용을 3~5줄로 자동 요약하여, 긴 기사도 빠르게 파악할 수 있도록 도와줍니다.</p>
      </div>
      <div class="feature-item">
        <div class="icon">💬</div>
        <h3>익명 자유 토론</h3>
      ...
      <div class="feature-item">
        <div class="icon">📂</div>
        <h3>25개 카테고리</h3>
        <p>정치, 경제, 사회, 생활문화, 세계, IT과학, 부동산, 헬스·건강, 스포츠, 연예 등 다양한 분야의 뉴스를 카테고리별로 탐색할 수 있습니다.</p>
      </div>
    </div>
  </div>
  ...
  <div class="section">
    <h2>📋 서비스 운영 목적</h2>
    <p>
      newscommu.com은 이용자가 다양한 관점의 뉴스를 한 곳에서 편리하게 접하고, 사회 현안에 대해 자유롭게 의견을 교환할 수 있는 플랫폼을 제공하기 위해 운영됩니다.
    </p>
    <p>
      특정 정치 성향이나 이념을 지지하지 않으며, 다양한 매체의 뉴스를 균형 있게 소개하고 건전한 커뮤니티 문화를 만들어 가는 것을 목표로 합니다.
    </p>
  </div>
  ...
  <div class="section">
    ...
    <table class="info-table">
      ...
      <tr><th>서비스 유형</th><td>뉴스 큐레이션 및 커뮤니티</td></tr>
