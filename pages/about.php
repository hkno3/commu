...
<div class="page-wrap">
  ...
  <div class="section">
    ...
    <p>
      정치, 경제, 사회, 문화, 스포츠 등 12개 카테고리의 최신 뉴스를 AI가 핵심만 요약해 제공하며, 누구나 익명으로 의견을 나눌 수 있습니다.
  ...
  <div class="section">
    ...
    <div class="feature-grid">
      <div class="feature-item">
        <div class="icon">📡</div>
        <h3>실시간 뉴스 수집</h3>
        <p>네이버 뉴스 API를 통해 정치, 경제, 사회, 생활문화, IT과학, 스포츠, 연예 등 12개 카테고리의 최신 기사를 실시간으로 수집합니다.</p>
      </div>
      <div class="feature-item">
        <div class="icon">🤖</div>
        <h3>AI 핵심 요약</h3>
      ...
      <div class="feature-item">
        <div class="icon">📂</div>
        <h3>12개 카테고리</h3>
        <p>정치, 경제, 사회, 생활문화, IT과학, 부동산, 헬스·건강, 스포츠, 연예 등 다양한 분야의 뉴스를 카테고리별로 탐색할 수 있습니다.</p>
      </div>
    </div>
  </div>
