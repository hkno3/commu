...
<div class="page-wrap">
  ...
  <div class="section">
    ...
    <p>
      정치, 경제, 사회, 생활/문화, IT/과학 등 핵심 카테고리의 뉴스를 AI가 읽기 쉽게 재정리하여 제공하며,
      특별 코너 <strong>천천히 늙자</strong>에서는 PubMed 최신 논문을 바탕으로 동물과 인간의 수명·건강수명 연구를 따뜻한 시각으로 소개합니다.
  ...
  <div class="section">
    ...
    <div class="feature-grid">
      <div class="feature-item">
        ...
        <h3>5대 카테고리 뉴스</h3>
        <p>정치, 경제, 사회, 생활/문화, IT/과학 분야의 최신 뉴스를 AI가 핵심만 뽑아 읽기 쉽게 정리해 제공합니다.</p>
      </div>
      <div class="feature-item">
        <div class="icon">🐾</div>
        <h3>천천히 늙자</h3>
        <p>PubMed 최신 논문을 AI가 한국어로 풀어써 동물 수명·노화 연구를 누구나 쉽게 이해할 수 있도록 소개합니다.</p>
      </div>
      <div class="feature-item">
        <div class="icon">🔬</div>
        <h3>주간 AI 연구 기획서</h3>
        <p>매주 월요일, 한 주간 쌓인 논문 포스트를 AI가 종합 분석해 실현 가능한 연구 아이디어를 제안합니다.</p>
      </div>
      <div class="feature-item">
        <div class="icon">💬</div>
        <h3>익명 자유 토론</h3>
  ...
  <div class="section">
    ...
    <p>
      ...
      특히 <strong>천천히 늙자</strong> 코너를 통해 반려동물과 함께 더 오래, 더 건강하게 살아가는 방법을 과학적 근거와 함께 탐구합니다.
    </p>
  </div>
  ...
  <div class="section">
    ...
    <table class="info-table">
      ...
      <tr><th>서비스 유형</th><td>AI 뉴스 큐레이션 및 토론 커뮤니티</td></tr>
