...
제목: (아래 규칙을 반드시 따를 것)
규칙1. {title} 이름 포함
규칙2. 이 여행지만의 세부 특징·볼거리·체험·계절·음식 중 1~2가지 키워드 반드시 추가
규칙3. 제목 끝은 명사로 마무리 ("~안내", "~명소", "~가이드", "~코스", "~추천" 등)
규칙4. 이모지 없이 30자 이내
규칙5. "완벽 여행 가이드", "여행 정보" 같은 뻔한 표현 절대 금지
좋은 예: "내소사 천년 고찰과 전나무 숲길 산책 코스", "해운대 해수욕장 일출과 마린시티 야경 명소"
나쁜 예(금지): "내소사(부안) 완벽 여행 가이드", "경복궁 여행 정보")
